...
public class GetDataBahanMenu extends javax.swing.JDialog {
    ...
    /**
     * Constructor untuk menambahkan bahan baru
     * 
     * @param parent
     * @param modal 
     */
    ...
    /**
     * Constructor untuk mengedit data bahan menu
     * 
     * @param parent
     * @param modal
     * @param idBahan
    ...
    public GetDataBahanMenu(java.awt.Frame parent, boolean modal, String idBahan, String quantity) {
        ...
        for(int i = 0; i < this.tabelData.getRowCount(); i++){
            ...
            if(this.tabelData.getValueAt(i, 0).equals(this.idSelected)){
                ...
                this.lblSatuan.setText(this.ba.getNamaSatuan(satuan));
                break;
            }
        }
    }
            ...
            while(this.db.res.next()){
                ...
                model.addRow(
                    new Object[]{
                        ...
                        txt.toMoneyCase(this.db.res.getString("harga"))
                    }
                );
            }
