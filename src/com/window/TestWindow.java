...
//        this.tabelData = new com.manage.StripedEvenInWhitePartsTable(new String[][]{}, new String[]{});
    ...
    private void initComponents() {
        ...
        lblNamaWindow.setText("Test Window");
        ...
        lblTotalData.setText("Menampilkan 20 data supplier dengan keyword \"test\"");

        tabelData.setFont(new java.awt.Font("Ebrima", 1, 14)); // NOI18N
        tabelData.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"SP001", "Achmad Baihaqi"},
                {"SP002", "Mohammad Ilham Islamy"},
                {"SP003", "Septian Yoga Pamungkas"},
                {"SP004", "Widyasari Raisya"}
            },
            new String [] {
