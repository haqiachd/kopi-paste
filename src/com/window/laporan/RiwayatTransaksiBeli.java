 ...
 */
public class RiwayatTransaksiBeli extends javax.swing.JDialog {
     ...
     * @param tahun
     */
    public RiwayatTransaksiBeli(java.awt.Frame parent, boolean modal, int bulan, int tahun) {
        super(parent, modal);
...
//        columnModel.getColumn(5).setMaxWidth(210);
    ...
    private void showDataRiwayat(){
        ...
        if(this.tabelRiwayat.getRowCount() <= 0){
            ...
            this.lblTotalPsRiwayat.setText(" Bahan : 0");
        ...
        for(int i = 0; i < this.tabelRiwayat.getRowCount(); i++){
            dipesan += Integer.parseInt(this.tabelRiwayat.getValueAt(i, 3).toString().replace(" Bahan", ""));
        ...
        this.lblTotalPsRiwayat.setText(String.format(" Total Bahan : %,d" , dipesan));
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(RiwayatTransaksiBeli.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                RiwayatTransaksiBeli dialog = new RiwayatTransaksiBeli(new javax.swing.JFrame(), true, 11, 2022);
