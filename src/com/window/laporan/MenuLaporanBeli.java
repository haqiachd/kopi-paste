 ...
 */
public class MenuLaporanBeli extends javax.swing.JFrame {
...
//        columnModel.getColumn(5).setMaxWidth(210);
    ...
    private void cariLaporanHarian(){
        ...
        this.resetTableLpHarian();
        DefaultTableModel model = (DefaultTableModel) this.tabelLpHarian.getModel();
        String key = inpCariHarian.getText().toLowerCase(), id, idKy, nama, tanggal;
    ...
    private void resetTableLpBulanan(){
        ...
        this.tabelLpBulanan.setModel(new javax.swing.table.DefaultTableModel(
            new String[][]{},
            new String [] {
                "Bulan", "Tahun", "Pembelian", "Dipesan", "Total Pengeluaran"
            }
        ) {
            boolean[] canEdit = new boolean[]{
    ...
    private void showDataLaporanBulanan(){
        ...
        this.lblTotalPsBulanan.setText(String.format(" Dipesan : %,d", this.psBulanan));
    ...
    private void resetTabelRiwayat(){
        ...
        this.tabelRiwayat.setModel(new javax.swing.table.DefaultTableModel(
                new String[][]{},
                new String [] {
                    "ID Transaksi", "ID Bahan", "Nama Bahan", "Jenis Bahan", "Jumlah", "Total Harga", "Tanggal"
                }
        ) {
            boolean[] canEdit = new boolean[]{
                false, false, false, false, false, false, false
...
//        columnModel.getColumn(6).setMaxWidth(130);
    ...
    private String getJenisBahan(){
        ...
        switch(tipe){
            ...
            case 6 : return "WHERE d.jenis_bahan = 'Bahan Jadi' ";
            default : return "";
        }
    }
    ...
    private void showListNamaBahan(){
        try{
            ...
            if(jenis.equalsIgnoreCase("Semua Jenis")){
                inpNamaMenu.setModel(new javax.swing.DefaultComboBoxModel(new String[]{"Semua Bahan"}));
                return;
            }
    ...
    private void showRiwayatTransaksi(){
        ...
        try{
            // membuat query
            String kondisi = this.getJenisBahan() + this.getNamaBahan() + " " + this.filterTglRiwayat,
                   sql = String.format(
                   "SELECT d.id_tr_beli, d.id_bahan, d.nama_bahan, d.jenis_bahan, d.satuan_bahan, d.jumlah, d.total_harga, t.tanggal "
                   + "FROM detail_tr_beli AS d "
                   + "JOIN transaksi_beli AS t "
                   + "ON t.id_tr_beli = d.id_tr_beli "
                   + "%s "
                   + "ORDER BY %s "
                   + "LIMIT 2000 ", kondisi, this.getUrutkanRiwayat()
            );
            System.out.println(sql);
            ...
            while(this.db.res.next()){
                ...
                model.addRow(// menambahkan data kedalam tabel
                    new Object[]{
                        id,
                        this.db.res.getString("d.id_bahan"),
                        this.db.res.getString("d.nama_bahan"),
                        this.db.res.getString("d.jenis_bahan"),
                        this.ba.getNilaiSatuan(Float.parseFloat(String.format("%.1f", this.db.res.getFloat("d.jumlah"))), this.db.res.getString("satuan_bahan")),
...
//            pesanan += Integer.parseInt(this.ba.removeSatuan(this.tabelRiwayat.getValueAt(i, 4).toString()));
            pesanan += Float.parseFloat(this.ba.removeSatuan(this.tabelRiwayat.getValueAt(i, 4).toString()));
            pengeluaran += Integer.parseInt(txt.removeMoneyCase(this.tabelRiwayat.getValueAt(i, 5).toString()));
        }
        
        // menampilkan data riwayat
        this.lblTotalTrRiwayat.setText(String.format(" Transaksi : %,d", transaksi));
        this.lblTotalPsRiwayat.setText(String.format(" Dipesan : %,d", (int)pesanan));
    ...
    private String getFavoriteBahan(){
        try{
            // membuat query
            String sql = String.format(
                    "SELECT d.nama_bahan, COUNT(d.id_bahan) AS total "
                  + "FROM detail_tr_beli AS d "
                  + "JOIN transaksi_beli AS t "
                  + "ON t.id_tr_beli = d.id_tr_beli "
                  + "%s %s %s "
                  + "GROUP BY nama_bahan ORDER BY total DESC, d.jumlah DESC "
                  + "LIMIT 0,1;", 
                    this.getJenisBahan(), this.getNamaBahan(),  this.filterTglRiwayat
            );
            System.out.println(sql);
    ...
    private void initComponents() {
        ...
        tabelLpHarian.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"TRJ001", "Mohammad Ilham", "4", "Rp. 25.000,00", "22 November 2022", null},
                {"TRJ002", "Mohammad Ilham", "7", "Rp. 89.000,00", "22 November 2022", null},
                {"TRJ003", "Widyasari Raisya", "2", "Rp. 10.000,00", "22 November 2022", null},
                {"TRJ004", "Septian Yoga", "3", "Rp. 17.500,00", "22 November 2022", null},
                {"TRJ005", "Widyasari Raisya", "1", "Rp. 8.000,00", "22 November 2022", null},
                {"TRJ006", "Mohammad Ilham", "3", "Rp. 18.000,00", "22 November 2022", null},
                {"TRJ007", "Mohammad Ilham", "4", "Rp. 23.000,00", "22 November 2022", null},
                {"TRJ008", "Septian Yoga", "3", "Rp. 11.000,00", "22 November 2022", null}
            },
            new String [] {
                "ID Transaksi", "Nama Karyawan", "Total Pesanan", "Total Harga", "Tanggal", "Waktu"
            }
        ) {
            boolean[] canEdit = new boolean [] {
                false, false, false, false, false, false
            ...
            .addGroup(pnlLaporanHarianLayout.createSequentialGroup()
                ...
                .addGroup(pnlLaporanHarianLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlLaporanHarianLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(pnlLaporanHarianLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(inpCariHarian, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(lblCari, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(0, 0, Short.MAX_VALUE))
        ...
        pnlRiwayatPembelian.setBackground(new java.awt.Color(248, 249, 250));
        ...
        inpUrutkan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tanggal ASC", "Tanggal DESC", "Nama Bahan ASC", "Nama Bahan DESC", "Jumlah Bahan ASC", "Jumlah Bahan DESC", "Total Harga ASC", "Total Harga DESC" }));
        ...
        inpJenisBahan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Semua Jenis", "Hewani", "Nabati", "Coffee", "Perasa", "Cairan", "Bahan Jadi" }));
        inpJenisBahan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                inpJenisBahanActionPerformed(evt);
            }
        });
        ...
        lblMenuFavRiwayat.setText(" Sering Dibeli : Kentang Goreng");
        ...
        javax.swing.GroupLayout pnlRiwayatPembelianLayout = new javax.swing.GroupLayout(pnlRiwayatPembelian);
        pnlRiwayatPembelian.setLayout(pnlRiwayatPembelianLayout);
        pnlRiwayatPembelianLayout.setHorizontalGroup(
            pnlRiwayatPembelianLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pnlRiwayatPembelianLayout.createSequentialGroup()
                .addGap(18, 18, 18)
                .addGroup(pnlRiwayatPembelianLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlRiwayatPembelianLayout.createSequentialGroup()
                        .addGroup(pnlRiwayatPembelianLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(pnlRiwayatPembelianLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(btnTgl, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addGap(26, 26, 26))
        );
        pnlRiwayatPembelianLayout.setVerticalGroup(
            pnlRiwayatPembelianLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlRiwayatPembelianLayout.createSequentialGroup()
                .addGap(27, 27, 27)
                .addGroup(pnlRiwayatPembelianLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlRiwayatPembelianLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(pnlRiwayatPembelianLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addGroup(pnlRiwayatPembelianLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(inpJenisBahan, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(18, 18, 18)
        ...
        tabPane.addTab("Riwayat Pembelian", pnlRiwayatPembelian);
    ...
    private void inpChartBulananActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_inpChartBulananActionPerformed
        ...
        switch(tipe){
            ...
            case 1 : 
                this.chart.showPieChart(this.pnlShowChart, ChartManager.PENGELUARAN, title, bulanDipilih, tahunDipilih);
                break;
            // jika yang dipilih adalah line chart
            case 2 : 
                this.chart.showLineChart(this.pnlShowChart, ChartManager.PENGELUARAN, title, bulanDipilih, tahunDipilih);
                break;
            case 3 :
                // jika yang dipilih adalah bar chart
                this.chart.showBarChart(this.pnlShowChart, ChartManager.PENGELUARAN, title, bulanDipilih, tahunDipilih);    
                break;
    ...
    private void btnDetailHarianActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetailHarianActionPerformed
        ...
        if(this.tabelLpHarian.getSelectedRow() >= 0){
            ...
            DetailTransaksiBeli dtr = new DetailTransaksiBeli(null, true, id);
            dtr.setVisible(true);            
        }else{
    ...
    private void btnCetakHarianActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakHarianActionPerformed
        ...
        this.setCursor(new Cursor(Cursor.WAIT_CURSOR));
        CetakLaporanHarian report = new CetakLaporanHarian(this, true, this.tabelLpHarian, this.db.conn, CetakLaporanHarian.STATUS_BELI, "Laporan Pembelian Harian", tglMulai, tglAkhir);
    ...
    private void btnCetakBulananActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakBulananActionPerformed
        ...
        CetakLaporanHarian report = new CetakLaporanHarian(this, true, this.tabelLpBulanan, this.db.conn, "unsupported-yet :|", "Laporan Pembelian Bulanan", tglMulai, tglAkhir);
        report.setVisible(true);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if(this.tabelLpHarian.getSelectedRow() > -1){
            ...
            SelectUpdateTransaksi sel = new SelectUpdateTransaksi(this, true, SelectUpdateTransaksi.STATUS_BELI, id);
            sel.setVisible(true);            
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuLaporanBeli.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new MenuLaporanBeli().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JComboBox inpJenisBahan;
    ...
    private javax.swing.JPanel pnlRiwayatPembelian;
