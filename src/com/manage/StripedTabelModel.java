...
public class StripedTabelModel extends JTable{

  public StripedTabelModel( String[][] data, String[] fields ){
    super( data, fields );
...
//        if ( actualRow % 2 == 0 )
//        {
//          newGraphics.setColor( new Color(255,255,255) ); //change this to another color (Color.YELLOW, anyone?) to show that only the free space is painted
...
//      }
  ...
  public Component prepareRenderer( TableCellRenderer renderer, int row, int column )
  {
    ...
    {
      c.setBackground( row % 2 == 0 ? getBackground() : new Color(231,235,239));
    }
  ...
  public static void main( String[] argv )
  {
    ...
    JTable table = new StripedTabelModel( data, fields );
