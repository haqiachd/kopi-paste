...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 24 Apr 2023 pada 16.16
...
('MN074', 'Menu 74', 'Original Coffee', 5000, '123456', NULL);
...
INSERT INTO `user` (`username`, `password`, `email`, `rfid`, `level`, `id_karyawan`) VALUES
('admin', '$2a$12$Nbi9AIfHGJOqTooF90gB2.ubkOZkfPHTl3M.Rnz0jN0Fk1SZNNJsa', 'hakiahmad756@gmail.com', '0008510015', 'ADMIN', 'KY005'),
('dev2003', '$2a$12$UiHP40gEGQNzyBORli.1hOiHtJ7Y08chmAbfrHXN1iupE/rTlc6fS', NULL, '0008277089', 'ADMIN', 'KY001'),
('ilham', '$2a$12$G9rldUjX0SjYYn169mMO3uLoRJOnlYKggCG5nojWOeOYSFxRnckNm', NULL, NULL, 'ADMIN', 'KY002'),
('ky01', '$2a$12$NFDmYAYqq19qDY/JnKoo3OSZ2PmVyy9BzR1O/rk4xiqJGk9nZw7G.', NULL, NULL, 'KARYAWAN', 'KY006'),
('ky02', '$2a$12$.d1sWsBEgV2IdWjgR3VhJeK/j7nlm/C9GbEycCHiybqJ2YzaqTAQi', NULL, NULL, 'KARYAWAN', 'KY007'),
('ky03', '$2a$12$mopMfxD2lh28mQJZ/a8vYOnj0vwrLfiqUHjtKIwDbSbO1aV5a77xG', NULL, NULL, 'KARYAWAN', 'KY008'),
('widya', '$2a$12$a2hZcCF4Of0r65cL1ef4/.GVnaCWf6/S0Z//MGtJLnSrpZaiJ7saK', NULL, NULL, 'ADMIN', 'KY003'),
('yoga', '$2a$12$a.WxR/w.Jd8MZ9KYWbcazuOwx9Y936X/QfhpQJwNT.Qe9ASei3PXu', NULL, NULL, 'ADMIN', 'KY004');
...
ALTER TABLE `menu`
  ...
  ADD UNIQUE KEY `id_barcode` (`id_barcode`);
